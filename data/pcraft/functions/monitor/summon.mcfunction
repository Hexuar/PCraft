...
# Summon Screen
summon block_display ^ ^ ^-0.25 {Tags:["pcraft.monitor","pcraft.new"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.4375f,0.21875f,0.09375f],scale:[0.875f,0.5f,0.001f]},block_state:{Name:"white_concrete"}}
