...
execute as @e[type=#pcraft:display_entities,tag=pcraft.key.pressed] if entity @s[type=block_display] run data modify entity @s transformation.scale[1] set value 0.03125f
