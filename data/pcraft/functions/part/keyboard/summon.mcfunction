...
summon interaction ^ ^ ^0.25 {Tags:["pcraft.entity","pcraft.keyboard","pcraft.new","pcraft.hitbox"],width:0.3425f,height:0.0625f}
summon interaction ^-0.27 ^ ^0.25 {Tags:["pcraft.entity","pcraft.keyboard","pcraft.new","pcraft.hitbox"],width:0.3425f,height:0.0625f}

# Summon Keyboard
summon block_display ^ ^ ^0.25 {Tags:["pcraft.entity","pcraft.keyboard","pcraft.new"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.43875f,0f,-0.17125f],scale:[0.8775f,0.0625f,0.3425f]}}
...
# Store Data
execute as @e[type=marker,tag=pcraft.part,tag=pcraft.keyboard,tag=pcraft.new,sort=nearest,limit=1] run function pcraft:part/keyboard/store_data
...
execute positioned ^ ^0.03125 ^0.25 run function pcraft:part/keyboard/summon_keys