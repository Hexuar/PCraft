...
summon block_display ^ ^ ^-0.25 {Tags:["pcraft.entity","pcraft.monitor","pcraft.new"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.46875f,0.1875f,0.03125f],scale:[0.9375f,0.5625f,0.0625f]},block_state:{Name:"gray_concrete"}}

# Summon Screen
summon block_display ^ ^ ^-0.25 {Tags:["pcraft.entity","pcraft.monitor","pcraft.new"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.4375f,0.21875f,0.09375f],scale:[0.875f,0.5f,0.001f]},block_state:{Name:"white_concrete"}}
...
# Summon Hitbox
summon interaction ^ ^ ^-0.25 {Tags:["pcraft.entity","pcraft.hitbox","pcraft.new"],width:0.4f,height:0.2f,response:1b}