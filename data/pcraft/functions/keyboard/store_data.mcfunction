data modify entity @s data.ItemData set value {id:"minecraft:armor_stand",Count:1b,tag:{display:{Name:'{"text":"Keyboard","italic":false}'},EntityTag:{Invisible:1b,Tags:["pcraft.spawn_part","pcraft.spawn_keyboard"],ArmorItems:[{},{},{},{}]}}}
