# Handle Input
execute as @e[type=marker,tag=pcraft.computer,sort=nearest,limit=1] run function pcraft:part/computer/handle_input with entity @e[type=marker,tag=pcraft.key,tag=pcraft.current,sort=nearest,limit=1,distance=..0.001] data
